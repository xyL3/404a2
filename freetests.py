...
class TestHTTPClient(unittest.TestCase):
    ...
    def testInternetGets(self):
        ...
        http = httpclass.HTTPClient()        
        urls = [
            "http://www.cs.ualberta.ca/",  # 301
            "http://softwareprocess.es/static/SoftwareProcess.es.html",   #302
            "http://c2.com/cgi/wiki?CommonLispHyperSpec",  #302
            "http://slashdot.org"   # 301
            ]
        for url in urls:
            try:
                req = http.GET( url )
